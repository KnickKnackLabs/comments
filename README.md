...
[![tests: 59](https://img.shields.io/badge/tests-59-brightgreen?style=flat)](test/)
...
The starter suite currently has **59 tests** and **3 public tasks**. Those numbers are read from the repo at README build time.
