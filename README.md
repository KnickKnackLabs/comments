...
[![tests: 8](https://img.shields.io/badge/tests-8-brightgreen?style=flat)](test/)
...
The starter suite currently has **8 tests** and **2 public tasks**. Those numbers are read from the repo at README build time.
